...
const getInqueries = async (req, res) => {
  try {
    await Inquery.find({})
      .sort({ date: -1 })
      .then((MongoDbRes) => {
        res.status(200).send(MongoDbRes);
      })
      .catch((err) => {
        throw err;
      });
          ...
          const mailOption = {
            ...
            <body>
              <div class="container">
                      ...
                      <div class="heading-hero">New Inquery for Ib ENG</div>
                  <div class="heading-hero1">Contact details</div>
